This repository contains a simple program that utilizes hexagonal architecture,
with the original source code provided by
[Alistair Cockburn](https://fr.wikipedia.org/wiki/Alistair_Cockburn)
in [Hexagonal](Hexagonal) folder.
